...
from biondeep_ig.bucket.click import arguments
from biondeep_ig.bucket.click import custom_types
...
from biondeep_ig.bucket.click.constants import OneOrManyPathType
from biondeep_ig.bucket.utils import get_bucket_manager
from biondeep_ig.bucket.utils import get_local_path
...
@click.option(
    ...
    "-b",
    required=True,
    type=custom_types.BucketPath(exists=True),
    help=(
...
@arguments.force(help="Force overwrite the local file if it already exists.")
...
@arguments.force(help="Force overwrite the bucket file if it already exists.")
