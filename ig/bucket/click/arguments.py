...
from ig.bucket.click.constants import DATA_BUCKET_NAME, GS_BUCKET_PREFIX, MODELS_BUCKET_NAME
from ig.bucket.click.custom_types import BucketOrDiskPath


def dataset_path(func: Callable) -> Any:
